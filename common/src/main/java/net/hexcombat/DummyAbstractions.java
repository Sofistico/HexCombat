...
public class DummyAbstractions {
     ...
     * Example:
     * <p>
     * Expect: net.hexcombat.DummyAbstractions#getConfigDirectory()
     * <p>
     * Actual Fabric: net.hexcombat.fabric.DummyAbstractionsImpl#getConfigDirectory()
     * <p>
     * Actual Forge: net.hexcombat.forge.DummyAbstractionsImpl#getConfigDirectory()
     * <p>
