...
# TO USE:
# python doc/collate_data.py common/src/main/resources doc/HexCastingResources hexcombat hexcombatbook doc/template.html doc/out.html
...
pattern_stubs = [(None, "net/hexcombat/registry/hexcombatPatternRegistry.java")]
