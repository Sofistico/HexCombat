...
import hexdoc_hexcombat

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexcombatPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexcombatModPlugin(branch=branch)


class HexcombatModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexcombat"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexcombat, "_templates"
